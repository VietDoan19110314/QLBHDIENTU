...
namespace QLCHDoDienTu {
    public class QLCHDoDienTu {
        ...
        public static void taoDSSanPham() {
            ...
            sanPhams[22] = new SanPham(26, "May dieu hoa Casper 1", 13000000, 2, 2021, 003, 5);
        ...
        public static void taoDSThanNhan() {
            ...
            thanNhans[1] = new ThanNhan(00002, "Le Thi Hong", "Me", "Nu", dt2, 000003);
            DateTime dt3 = new DateTime(1961, 7, 6, 5, 31, 11);
            thanNhans[2] = new ThanNhan(00003, "Tran Hoang Long", "Bo", "Nam", dt3, 000002);
            DateTime dt4 = new DateTime(1961, 8, 7, 6, 32, 12);
            thanNhans[3] = new ThanNhan(00004, "Dinh Nguyen Bao", "Bo", "Nam", dt4, 000004);
            DateTime dt5 = new DateTime(1954, 5, 13, 6, 59, 4);
            thanNhans[4] = new ThanNhan(00005, "To Ngoc Anh", "Me", "Nu", dt5, 000005);
            DateTime dt6 = new DateTime(1955, 6, 14, 2, 59, 2);
            thanNhans[5] = new ThanNhan(00006, "Tran Dang Khoa", "Bo", "Nam", dt6, 000006);
        ...
        public static void taoDSKho() {
            ...
            khos[2] = new Kho(0000001, 04, 42);
            khos[3] = new Kho(0000001, 06, 27);
            khos[4] = new Kho(0000001, 08, 23);
            khos[5] = new Kho(0000001, 10, 50);
            khos[6] = new Kho(0000001, 02, 11);
            khos[7] = new Kho(0000001, 05, 12);
            khos[8] = new Kho(0000001, 07, 13);
            khos[9] = new Kho(0000001, 09, 14);
            khos[10] = new Kho(0000002, 01, 15);
            khos[11] = new Kho(0000002, 03, 16);
            khos[12] = new Kho(0000002, 04, 17);
            khos[13] = new Kho(0000002, 06, 18);
            khos[14] = new Kho(0000002, 02, 19);
            khos[15] = new Kho(0000002, 05, 19);
            khos[16] = new Kho(0000002, 07, 19);
            khos[17] = new Kho(0000002, 08, 19);
            khos[18] = new Kho(0000002, 09, 19);
            khos[19] = new Kho(0000002, 10, 19);
            khos[20] = new Kho(0000003, 11, 20);
            khos[21] = new Kho(0000003, 12, 10);
            khos[22] = new Kho(0000003, 13, 11);
            khos[23] = new Kho(0000003, 14, 10);
            khos[24] = new Kho(0000003, 15, 10);
            khos[25] = new Kho(0000003, 18, 13);
            khos[26] = new Kho(0000003, 19, 14);
        ...
        public static void taoDSChiTietHoaDon() {
            ...
            chiTietHoaDons[2] = new ChiTietHoaDon(100, 02, 5, 10);
            chiTietHoaDons[3] = new ChiTietHoaDon(100, 03, 3, 10);
            chiTietHoaDons[4] = new ChiTietHoaDon(100, 04, 4, 10);
            chiTietHoaDons[5] = new ChiTietHoaDon(100, 05, 1, 10);
            chiTietHoaDons[6] = new ChiTietHoaDon(100, 06, 1, 10);
            chiTietHoaDons[7] = new ChiTietHoaDon(101, 01, 2, 20);
            chiTietHoaDons[8] = new ChiTietHoaDon(101, 07, 4, 20);
            chiTietHoaDons[9] = new ChiTietHoaDon(101, 08, 8, 20);
            chiTietHoaDons[10] = new ChiTietHoaDon(101, 09, 9, 20);
            chiTietHoaDons[11] = new ChiTietHoaDon(101, 03, 2, 20);
            chiTietHoaDons[12] = new ChiTietHoaDon(101, 04, 3, 20);
            chiTietHoaDons[13] = new ChiTietHoaDon(101, 05, 1, 20);
            chiTietHoaDons[14] = new ChiTietHoaDon(101, 06, 2, 20);
            chiTietHoaDons[15] = new ChiTietHoaDon(102, 01, 4, 10);
            chiTietHoaDons[16] = new ChiTietHoaDon(102, 02, 3, 10);
            chiTietHoaDons[17] = new ChiTietHoaDon(102, 03, 6, 10);
            chiTietHoaDons[18] = new ChiTietHoaDon(102, 04, 7, 10);
            chiTietHoaDons[19] = new ChiTietHoaDon(102, 05, 9, 10);
            chiTietHoaDons[20] = new ChiTietHoaDon(102, 06, 10, 10);
            chiTietHoaDons[21] = new ChiTietHoaDon(102, 07, 1, 10);
            chiTietHoaDons[22] = new ChiTietHoaDon(103, 01, 9, 30);
            chiTietHoaDons[23] = new ChiTietHoaDon(103, 02, 8, 30);
            chiTietHoaDons[24] = new ChiTietHoaDon(103, 03, 7, 30);
            chiTietHoaDons[25] = new ChiTietHoaDon(103, 04, 6, 30);
            chiTietHoaDons[26] = new ChiTietHoaDon(104, 05, 5, 10);
            chiTietHoaDons[27] = new ChiTietHoaDon(104, 06, 4, 10);
            chiTietHoaDons[28] = new ChiTietHoaDon(104, 07, 3, 10);
            chiTietHoaDons[29] = new ChiTietHoaDon(105, 08, 1, 35);
            chiTietHoaDons[30] = new ChiTietHoaDon(105, 09, 3, 35);
            chiTietHoaDons[31] = new ChiTietHoaDon(105, 10, 4, 35);
            chiTietHoaDons[32] = new ChiTietHoaDon(105, 01, 7, 35);
            chiTietHoaDons[33] = new ChiTietHoaDon(106, 10, 20, 10);
            chiTietHoaDons[34] = new ChiTietHoaDon(107, 01, 1, 0);
            chiTietHoaDons[35] = new ChiTietHoaDon(107, 03, 2, 0);
            chiTietHoaDons[36] = new ChiTietHoaDon(108, 11, 1, 15);
            chiTietHoaDons[37] = new ChiTietHoaDon(108, 12, 2, 15);
            chiTietHoaDons[38] = new ChiTietHoaDon(108, 13, 3, 15);
            chiTietHoaDons[39] = new ChiTietHoaDon(108, 14, 4, 15);
            chiTietHoaDons[40] = new ChiTietHoaDon(108, 15, 5, 15);
            chiTietHoaDons[41] = new ChiTietHoaDon(109, 16, 6, 13);
            chiTietHoaDons[42] = new ChiTietHoaDon(109, 17, 7, 13);
            chiTietHoaDons[43] = new ChiTietHoaDon(109, 18, 8, 13);
            chiTietHoaDons[44] = new ChiTietHoaDon(109, 19, 9, 13);
            chiTietHoaDons[45] = new ChiTietHoaDon(109, 20, 10, 13);
            chiTietHoaDons[46] = new ChiTietHoaDon(109, 21, 11, 13);
            chiTietHoaDons[47] = new ChiTietHoaDon(110, 22, 12, 40);
            chiTietHoaDons[48] = new ChiTietHoaDon(110, 23, 13, 40);
            chiTietHoaDons[49] = new ChiTietHoaDon(110, 24, 14, 40);
            chiTietHoaDons[50] = new ChiTietHoaDon(110, 11, 15, 40);
